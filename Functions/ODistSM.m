function [n, centers, S, MedOrient] = ODistSM(IDPath,angleStep,Label,varargin)

% This is to fix the number scheme from order of collection to clockwise on
% chip [original file label, new clockwise label]
% SpinShift = [1 1; 2 2; 9 3; 13 4; 16 5; 3 6; 18 7; 12 8; 8 9; 7 10; 6 11; 5 12; 14 13; 11 14; 4 15; 17 16; 15 17; 10 18];
SpinShift = [1 2 6 15 12 11 10 9 3 18 14 8 4 13 17 5 16 7];
...
text('Units', 'normalized', 'Position', [-0.1 0.9], ...
    'BackgroundColor', [1 1 1], ...
    'String', num2str(SpinShift(Label)),...
    'FontSize', 40);
...
hgexport(gcf, ['~/Documents/GA Tech/Research/Papers/Quantification of P3HT Microstructure/Spin Spiders/', num2str(SpinShift(Label)), '.tif'],  ...
